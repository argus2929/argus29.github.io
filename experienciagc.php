...
<body class="fondoPulsera" style="overflow: hidden;">
    ...
    <div class="navbarExp navbar-normal">
        <img src="img/logoBlanco.png" alt="Logo" class="navbar-logo" id="logo">
        <div class="flexRow">
            <a href="clientes.php#btnBajar" class="navbar-text-exp">Quiénes somos</a>
            <a href="dancaceres.php" class="navbar-text-exp" id="headerMentor">El Mentor de los Seguros</a>
        </div>
        <a href="clientes.php#cotizar" class="navbar-text-exp">Contáctanos</a>
